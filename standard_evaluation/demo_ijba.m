...
data_dir = '/home/4/FaceDataSets/Test/IJB-A/IJB-A_images';
code_dir = '/home/3/vggface2_caffe_model/dev_kit';
table_path = '/home/4/FaceDataSets/Test/IJB-A/IJB-A_11_sets/split1/verify_metadata_1.csv';
det_tight_data_dir = '/home/3/cm/IJB-A_vggface/data';
...
dir(fullfile(det_tight_data_dir, 'debug'));
for i = 1: length(imglist)
    ...
    try 
 	img = imread(img_path);
        ...
        f1 = fullfile(det_tight_data_dir, ['debug/', img_name]);
        f2 = fullfile(det_tight_data_dir, ['debug/1_', img_name]);
